...
// document.getElementById("some-id").style; // Accesses CSS rules for "some-id" element

// document.getElementById("some-id").style.border = "2px solid black";

// document.getElementById("some-image").src = "image/newpic.jpg" // Changes an image
...
function changeToAndroid() {
  // Change the Android vs Apple image to the android logo in the image folder
